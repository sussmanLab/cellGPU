...
class VertexQuadraticEnergyWithTension : public VertexQuadraticEnergy
    ...
    public:
        ...
        VertexQuadraticEnergyWithTension(int n, Dscalar A0, Dscalar P0,bool reprod = false, bool runSPVToInitialize=false) : VertexQuadraticEnergy(n,A0,P0,reprod){gamma = 0;Tension = false;simpleTension = true;};
