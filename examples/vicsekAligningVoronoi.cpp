...
int main(int argc, char*argv[])
{
    ...
    char dataname[256];
    sprintf(dataname,"./vvVicsekCorr_N%i_p0%.3f_v0%.3f_J%.3f_fidx%i.nc",numpts,p0,v0,J,fIdx);
    char dataname2[256];
    sprintf(dataname2,"./PhiVicsek_N%i_p0%.3f_v0%.3f_J%.3f_fidx%i.nc",numpts,p0,v0,J,fIdx);
