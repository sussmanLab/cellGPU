#ifndef SIMPLEVERTEXDATABASE_H
#define SIMPLEVERTEXDATABASE_H

#include "baseHDF5Database.h"
#include "voronoiQuadraticEnergy.h"

/*! \file simpleVertexDatabase.h */
...
private:
    ...
    //! a vector of length 2*Nc
    std::vector<double> cellCoordinateVector;
    //! a vector of length N
    std::vector<double> doubleVector;
    //! a vector of length N
    std::vector<int> intVector;
    //! a vector of length 3*N
    std::vector<int> vertexNeighborVector;
    //! a vector of length 3*N
    std::vector<int> vertexCellNeighborVector;
